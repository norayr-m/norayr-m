...
### → [the work — interactive substrate preview](https://norayr-m.github.io/norayr-m/the-work/)

Chaptered audio narration, 13+ inline visualizations, calibration discipline throughout. Headline: **14.4 GCUPS at 1 billion hex cells on a single M5 Max laptop, 10-run published**. Companion [wiki](https://github.com/norayr-m/norayr-m/wiki) keeps the same content as static text — canonical public progress record, maintained as new artefacts land.
